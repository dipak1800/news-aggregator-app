//CLICK ON THE NEWS ICON ON THE TOP TO GET DETAILS ABOUT PROJEC
var options = {
  position: "fixed",
  right: "unset",
  left: "8px",
...
const url =
  "https://newsapi.org/v2/top-headlines?country=in&apiKey=9d7ddb7c0b54416688c9a8b49b2274cb";
  ...
  if (result.totalResults > 0) {
    ...
    result.articles.forEach((element) => {
      output += `<li class="article">
                   <img class="article-img" src="${element.urlToImage}" alt="Image Not Availiable" style="width:100%;border-radius:5px;height:auto;padding:15px">
...
setTimeout(() => {
  document.getElementById(
    "placeme"
  ).innerHTML = `<marquee  class="moving " behavior="alternate" scrollamount="13">Thanks for visitng NEWS Aggregator App.Hope You Enjoyed <i class="fas fa-smile-wink"></i> It! </marquee>`;
}, 10000);
